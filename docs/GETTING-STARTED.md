...
[`templates/`](../templates/), the shipped **lesson set** under
...
- Read a shipped lesson, e.g.
  [`sets/de/fuehrerschein-uebung/lessons/01-vorfahrt-kreuzungen.json`](../sets/de/fuehrerschein-uebung/lessons/01-vorfahrt-kreuzungen.json)
  (theory + multiple-choice exercises).
